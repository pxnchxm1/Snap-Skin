              ...
              {session ? (
                <form action ={logout} className="items-center justify-center flex flex-col gap-4">
                        ...
                        <Link href='/dashboard' className="px-2 justify-center items-center flex">
                                <div className=" px-4 py-2  items-center justify-center flex flex-row text-purple-700 dark:text-white font-medium text-xl rounded-lg border border-purple-700 hover:bg-purple-400 dark:hover:bg-slate-900 ">
                                    Dashboard
                                </div>
                            </Link>
