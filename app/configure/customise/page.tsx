...
const handleCupMaterialSelect = (name: string): void => {
  ...
  return (
    <div className="justify-center items-center flex flex-col gap-4">
          <div className="flex flex-col  justify-center  items-center md:justify-between  dark:bg-slate-900 lg:flex-row lg:h-[60vh] ">
            <section className="flex flex-col justify-center px-2 lg:px-16 items-center  bg-gray-200 p-2 h-full dark:bg-slate-900  ">
              <CustomImage/>
            </section>
            <section className="flex flex-col  justify-center  lg:justify-start items-start md:p-4 p-2 w-full overflow-x-hidden gap-4  h-full bg-white dark:bg-black ">
